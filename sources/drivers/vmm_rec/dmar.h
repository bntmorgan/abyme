...
// PCI Express field
struct dmar_root_table_address {
  union {
    struct {
      uint64_t r0:11;
...
struct dmar_pages {
  // Device to domain
  struct dmar_root_entry root_table[256] __attribute__((aligned(0x1000)));
  struct dmar_context_entry context_table[256][256] __attribute__((aligned(0x1000)));
  // Address translation level 2
  struct dmar_sl_pml4_entry pml4[512] __attribute((aligned(0x1000)));
  struct dmar_sl_pdpt_entry pdpt[512] __attribute((aligned(0x1000)));
};
