...
OBJS_$(d)				:= $(call SRC_2_OBJ, \
										$(d)/efi.o $(d)/82579LM.o $(d)/common/cpu.o $(d)/pci.o $(d)/debug_eth.o $(d)/api.o $(d)/common/string.o $(d)/common/stdio.o $(d)/common/pat.o $(d)/common/mtrr.o $(d)/common/msr.o $(d)/common/paging.o $(d)/common/screen.o $(d)/common/stdlib.o $(d)/common/cpuid.o $(d)/common/efiw.o)
OBJECTS 				+= $(OBJS_$(d))
