...
OBJS_$(d)				:= $(call SRC_2_OBJ, \
										$(d)/efi.o $(d)/vmm.o $(d)/common/efiw.o $(d)/common/screen.o $(d)/common/stdio.o $(d)/common/stdlib.o $(d)/common/debug.o $(d)/cpu.o $(d)/cpuid.o $(d)/msr.o $(d)/vmexit.o $(d)/setup.o $(d)/vmcs.o $(d)/gdt.o $(d)/mtrr.o $(d)/common/string.o $(d)/ept.o $(d)/msr_bitmap.o $(d)/paging.o $(d)/pat.o $(d)/io_bitmap.o $(d)/pci.o $(d)/trampo.o $(d)/smp.o, $(d)/test.o $(d)/smp.o)
